                              ...
                              u.setPassword ? (
                                <span className="flex items-center gap-1">
                                  ...
                                  <button
                                    ...
                                    title="Copy password"
                                    className={`rounded-lg px-1.5 py-0.5 text-xs font-medium ${copiedPwId === u.id ? 'bg-emerald-50 text-emerald-600' : 'text-gray-400 hover:bg-gray-100 hover:text-gray-600'}`}
                                  >
